        ...
        <div className="lg:col-span-7 flex justify-center lg:justify-end w-full">
          <div className="w-full max-w-xl bg-surface-container-lowest rounded-2xl shadow-xl p-8 sm:p-10 relative overflow-hidden border border-outline-variant/20">
            ...
            <button
              ...
              className="w-full h-12 py-3 px-4 rounded-xl bg-surface hover:bg-surface-container transition-all duration-200 shadow-sm hover:shadow flex items-center justify-center gap-3 cursor-pointer group border border-outline-variant/30 mb-6"
              type="button"
            >
